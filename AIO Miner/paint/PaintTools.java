...
public class PaintTools {
	...
	public PaintTools(ExperienceTracker xpTracker, AIOMiner m) {
	...
	public int getXpGained() {
		return xpTracker.getGainedXP(Skill.MINING);
	}
		
	public int getXpPerHour() {
		return xpTracker.getGainedXPPerHour(Skill.MINING);
	}
	
	public int getLevelsGained() {
		return xpTracker.getGainedLevels(Skill.MINING);
	}
